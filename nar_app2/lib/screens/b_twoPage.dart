...
import '../models/db_connectbtwo.dart';
import '../widgets/result_box.dart';

class PagebTwo extends StatefulWidget {
  const PagebTwo({Key? key}) : super(key: key);

  @override
  _PagebTwoState createState() => _PagebTwoState();
}

class _PagebTwoState extends State<PagebTwo> {
